...
# 	path('comment/<int:id>', views.comment, name='comment'),
    ...
    # path('banktocash/<int:id>', views.banktocash, name='banktocash'),#remove
    path('bank_to_cash_transfer/<int:id>/', views.bank_to_cash_transfer, name='bank_to_cash_transfer'),
